...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="BeamPointing General hacking.vi" Type="VI" URL="../subVIs/BeamPointing General hacking.vi"/>
		<Item Name="BeamPointing General v08.vi" Type="VI" URL="../subVIs/BeamPointing General v08.vi"/>
		<Item Name="TRA server.vi" Type="VI" URL="../subVIs/100TW TRA motor server/TRA server.vi"/>
		<Item Name="GrabImageUDP.vi" Type="VI" URL="../subVIs/GrabImageUDP.vi"/>
		<Item Name="connect udp image server.vi" Type="VI" URL="../subVIs/connect udp image server.vi"/>
		<Item Name="rescale intensity imaq image.vi" Type="VI" URL="../subVIs/rescale intensity imaq image.vi"/>
		<Item Name="annotate image.vi" Type="VI" URL="../subVIs/annotate image.vi"/>
		<Item Name="manual-move-general.vi" Type="VI" URL="../subVIs/manual-move-general.vi"/>
		<Item Name="In Range Array.vi" Type="VI" URL="../subVIs/In Range Array.vi"/>
		<Item Name="notify user TRA problem.vi" Type="VI" URL="../subVIs/notify user TRA problem.vi"/>
		<Item Name="check for new image.vi" Type="VI" URL="../subVIs/check for new image.vi"/>
		<Item Name="is image clear.vi" Type="VI" URL="../subVIs/is image clear.vi"/>
		<Item Name="copy and overlay delete.vi" Type="VI" URL="../subVIs/copy and overlay delete.vi"/>
		<Item Name="Update image if new.vi" Type="VI" URL="../subVIs/Update image if new.vi"/>
		<Item Name="overlay target circles.vi" Type="VI" URL="../subVIs/overlay target circles.vi"/>
		<Item Name="Overlay detection problem.vi" Type="VI" URL="../subVIs/Overlay detection problem.vi"/>
		<Item Name="Select Target Circle Colors.vi" Type="VI" URL="../subVIs/Select Target Circle Colors.vi"/>
		<Item Name="temporary multiple image tcp example.vi" Type="VI" URL="../subVIs/TCP/temporary multiple image tcp example.vi"/>
		<Item Name="TCP Multiple Connections - Client - subvi - ajg.vi" Type="VI" URL="../subVIs/TCP/TCP Multiple Connections - Client - subvi - ajg.vi"/>
		<Item Name="send TRA command-v-03.vi" Type="VI" URL="../subVIs/100TW TRA motor server/send TRA command-v-03.vi"/>
		<Item Name="associate mirrors and cameras.vi" Type="VI" URL="../subVIs/associate mirrors and cameras.vi"/>
		<Item Name="parse device list by type.vi" Type="VI" URL="../subVIs/parse device list by type.vi"/>
		<Item Name="test9cameras.vi" Type="VI" URL="../test9cameras.vi"/>
		<Item Name="target.ico" Type="Document" URL="../subVIs/target.ico"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="IMAQ Write Image And Vision Info" Type="VI" URL="/&lt;vilib&gt;/vision/Files1.llb/IMAQ Write Image And Vision Info"/>
			...
			<Item Name="Send Move Command.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/Send Move Command.vi"/>
			<Item Name="RemoveConnectionID.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/RemoveConnectionID.vi"/>
			<Item Name="LoadConnectionIDerror.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/LoadConnectionIDerror.vi"/>
			<Item Name="PicoCmdClientMove_5.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/PicoCmdClientMove_5.vi"/>
			<Item Name="pico_ctlstostring_2.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/pico_ctlstostring_2.vi"/>
			<Item Name="Move Controller-v2.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/Move Controller-v2.vi"/>
			<Item Name="TCPwrite512B-client.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/TCPwrite512B-client.vi"/>
			<Item Name="LoadConnectionID.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/LoadConnectionID.vi"/>
			<Item Name="StripEmtyLines.vi" Type="VI" URL="../subVIs/StripEmtyLines.vi"/>
			<Item Name="overlay oval ajg.vi" Type="VI" URL="../subVIs/overlay oval ajg.vi"/>
			<Item Name="TCP Listen.vi" Type="VI" URL="../subVIs/100TW TRA motor server/picomotor_server_lv82.llb/TCP Listen.vi"/>
			<Item Name="Internecine Avoider.vi" Type="VI" URL="../subVIs/100TW TRA motor server/picomotor_server_lv82.llb/Internecine Avoider.vi"/>
			<Item Name="TCP Listen List Operations.ctl" Type="VI" URL="../subVIs/100TW TRA motor server/picomotor_server_lv82.llb/TCP Listen List Operations.ctl"/>
			<Item Name="TCP Listen Internal List.vi" Type="VI" URL="../subVIs/100TW TRA motor server/picomotor_server_lv82.llb/TCP Listen Internal List.vi"/>
			<Item Name="ChangeStatusCmdCluster.vi" Type="VI" URL="../subVIs/100TW TRA motor server/ChangeStatusCmdCluster.vi"/>
			<Item Name="motor number to motor cluster number.vi" Type="VI" URL="../subVIs/100TW TRA motor server/motor number to motor cluster number.vi"/>
			<Item Name="pico_stringtoctls.vi" Type="VI" URL="../subVIs/100TW TRA motor server/pico_stringtoctls.vi"/>
			<Item Name="compare target and actual motor positions.vi" Type="VI" URL="../subVIs/100TW TRA motor server/compare target and actual motor positions.vi"/>
			<Item Name="motor string cluster to numeric array.vi" Type="VI" URL="../subVIs/100TW TRA motor server/motor string cluster to numeric array.vi"/>
			<Item Name="target motor string cluster to numeric array.vi" Type="VI" URL="../subVIs/100TW TRA motor server/target motor string cluster to numeric array.vi"/>
			<Item Name="ChangeExecTimeCmdCluster.vi" Type="VI" URL="../subVIs/100TW TRA motor server/ChangeExecTimeCmdCluster.vi"/>
			<Item Name="ReplaceErrorConnectID.vi" Type="VI" URL="../subVIs/100TW TRA motor server/ReplaceErrorConnectID.vi"/>
			<Item Name="ErrorConnectID.vi" Type="VI" URL="../subVIs/100TW TRA motor server/ErrorConnectID.vi"/>
			<Item Name="SeparateCmd_3.vi" Type="VI" URL="../subVIs/100TW TRA motor server/SeparateCmd_3.vi"/>
			<Item Name="TCPread512B-server.vi" Type="VI" URL="../subVIs/100TW TRA motor server/TCPread512B-server.vi"/>
			<Item Name="RemoveConnectID for PicoPadServer.vi" Type="VI" URL="../subVIs/100TW TRA motor server/RemoveConnectID for PicoPadServer.vi"/>
			<Item Name="TCPwrite8bytes.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/TCPwrite8bytes.vi"/>
			<Item Name="OntrakControll.vi" Type="VI" URL="../subVIs/OntrakControll.vi"/>
			<Item Name="LoadDeviceList.vi" Type="VI" URL="../subVIs/LoadDeviceList.vi"/>
			<Item Name="DOMUserDefRef.dll" Type="Document" URL="DOMUserDefRef.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="GetXMLDeviceID.vi" Type="VI" URL="../subVIs/GetXMLDeviceID.vi"/>
			<Item Name="GetXMLImageServer.vi" Type="VI" URL="../subVIs/GetXMLImageServer.vi"/>
			<Item Name="getXMLDetectionParameters.vi" Type="VI" URL="../subVIs/getXMLDetectionParameters.vi"/>
			<Item Name="getXMLReverse.vi" Type="VI" URL="../subVIs/getXMLReverse.vi"/>
			<Item Name="getXMLPoint.vi" Type="VI" URL="../subVIs/getXMLPoint.vi"/>
			<Item Name="getXMLAcquisitionParameters.vi" Type="VI" URL="../subVIs/getXMLAcquisitionParameters.vi"/>
			<Item Name="getXMLArray.vi" Type="VI" URL="../subVIs/getXMLArray.vi"/>
			<Item Name="getXMLCameraPlacement.vi" Type="VI" URL="../subVIs/getXMLCameraPlacement.vi"/>
			<Item Name="NumberToDeviceID-v2.vi" Type="VI" URL="../subVIs/NumberToDeviceID-v2.vi"/>
			<Item Name="Create Image Array.vi" Type="VI" URL="../subVIs/Create Image Array.vi"/>
			<Item Name="LoadImages.vi" Type="VI" URL="../subVIs/LoadImages.vi"/>
			<Item Name="Substract Background.vi" Type="VI" URL="../subVIs/Substract Background.vi"/>
			<Item Name="Beam Detection-v6.vi" Type="VI" URL="../subVIs/Beam Detection-v6.vi"/>
			<Item Name="IntensityProfileAlongCoord.vi" Type="VI" URL="../subVIs/IntensityProfileAlongCoord.vi"/>
			<Item Name="Add ROI Offset.vi" Type="VI" URL="../subVIs/Add ROI Offset.vi"/>
			<Item Name="Add ROI Offset ImgData.vi" Type="VI" URL="../subVIs/Add ROI Offset ImgData.vi"/>
			<Item Name="Add ROI Offset RectFilter.vi" Type="VI" URL="../subVIs/Add ROI Offset RectFilter.vi"/>
			<Item Name="Add ROI Offset ImgDataAvg.vi" Type="VI" URL="../subVIs/Add ROI Offset ImgDataAvg.vi"/>
			<Item Name="Run Centroid Detection.vi" Type="VI" URL="../subVIs/Run Centroid Detection.vi"/>
			<Item Name="Copy i_th image to array v2.vi" Type="VI" URL="../subVIs/Copy i_th image to array v2.vi"/>
			<Item Name="Threshold Img v2.vi" Type="VI" URL="../subVIs/Threshold Img v2.vi"/>
			<Item Name="RemoveBadSpotImage-v3.vi" Type="VI" URL="../subVIs/RemoveBadSpotImage-v3.vi"/>
			<Item Name="DataAverager.vi" Type="VI" URL="../subVIs/DataAverager.vi"/>
			<Item Name="Greyscale Image Averager3.vi" Type="VI" URL="../subVIs/Greyscale Image Averager3.vi"/>
			<Item Name="IMAQ Dispose Buffer.vi" Type="VI" URL="../subVIs/IMAQ Dispose Buffer.vi"/>
			<Item Name="percent true of DeviationArray.vi" Type="VI" URL="../subVIs/percent true of DeviationArray.vi"/>
			<Item Name="AutoDetect.vi" Type="VI" URL="../subVIs/AutoDetect.vi"/>
			<Item Name="FindNrSteps.vi" Type="VI" URL="../subVIs/FindNrSteps.vi"/>
			<Item Name="Remove Duplicates 2D.vi" Type="VI" URL="../subVIs/Remove Duplicates 2D.vi"/>
			<Item Name="Sort 2 Column Array By First Column.vi" Type="VI" URL="../subVIs/Sort 2 Column Array By First Column.vi"/>
			<Item Name="Add Or Replace History Array.vi" Type="VI" URL="../subVIs/Add Or Replace History Array.vi"/>
			<Item Name="Add point in History v2.vi" Type="VI" URL="../subVIs/Add point in History v2.vi"/>
			<Item Name="Replace Or Add.vi" Type="VI" URL="../subVIs/Replace Or Add.vi"/>
			<Item Name="Add Or Replace Coord Array.vi" Type="VI" URL="../subVIs/Add Or Replace Coord Array.vi"/>
			<Item Name="Add Or Replace Img Array.vi" Type="VI" URL="../subVIs/Add Or Replace Img Array.vi"/>
			<Item Name="Add Or Replace String Array.vi" Type="VI" URL="../subVIs/Add Or Replace String Array.vi"/>
			<Item Name="Draw Ellipse.vi" Type="VI" URL="../subVIs/Draw Ellipse.vi"/>
			<Item Name="circle graph.vi" Type="VI" URL="../subVIs/circle graph.vi"/>
			<Item Name="ellipse graph.vi" Type="VI" URL="../subVIs/ellipse graph.vi"/>
			<Item Name="Rectangle Overlay for 2 Cursors.vi" Type="VI" URL="../subVIs/Rectangle Overlay for 2 Cursors.vi"/>
			<Item Name="History remove zeros.vi" Type="VI" URL="../subVIs/History remove zeros.vi"/>
			<Item Name="TCPread8bytes.vi" Type="VI" URL="../subVIs/Comm for BeamPointing.llb/TCPread8bytes.vi"/>
			<Item Name="EndOfMove-2.vi" Type="VI" URL="../subVIs/EndOfMove-2.vi"/>
			<Item Name="newCameraPrompt.vi" Type="VI" URL="../subVIs/newCameraPrompt.vi"/>
			<Item Name="Save Background Img.vi" Type="VI" URL="../subVIs/Save Background Img.vi"/>
			<Item Name="Save Reference Img.vi" Type="VI" URL="../subVIs/Save Reference Img.vi"/>
			<Item Name="Color Table Generator.vi" Type="VI" URL="../subVIs/Color Table Generator.vi"/>
			<Item Name="Component Generator.vi" Type="VI" URL="../subVIs/Component Generator.vi"/>
			<Item Name="SaveCamConfig-v5.vi" Type="VI" URL="../subVIs/SaveCamConfig-v5.vi"/>
			<Item Name="SaveDeviceList.vi" Type="VI" URL="../subVIs/SaveDeviceList.vi"/>
			<Item Name="appendXMLID.vi" Type="VI" URL="../subVIs/appendXMLID.vi"/>
			<Item Name="appendXMLName.vi" Type="VI" URL="../subVIs/appendXMLName.vi"/>
			<Item Name="Save DeviceID.vi" Type="VI" URL="../subVIs/Save DeviceID.vi"/>
			<Item Name="appendXMLDetectParam.vi" Type="VI" URL="../subVIs/appendXMLDetectParam.vi"/>
			<Item Name="appendXMLReverse.vi" Type="VI" URL="../subVIs/appendXMLReverse.vi"/>
			<Item Name="appendXMLTarget.vi" Type="VI" URL="../subVIs/appendXMLTarget.vi"/>
			<Item Name="appendXMLPoint.vi" Type="VI" URL="../subVIs/appendXMLPoint.vi"/>
			<Item Name="appendXMLROI.vi" Type="VI" URL="../subVIs/appendXMLROI.vi"/>
			<Item Name="appendXMLCorrectionParameters.vi" Type="VI" URL="../subVIs/appendXMLCorrectionParameters.vi"/>
			<Item Name="appendXMLAcqParam.vi" Type="VI" URL="../subVIs/appendXMLAcqParam.vi"/>
			<Item Name="appendXMLBackground.vi" Type="VI" URL="../subVIs/appendXMLBackground.vi"/>
			<Item Name="appendXMLReference.vi" Type="VI" URL="../subVIs/appendXMLReference.vi"/>
			<Item Name="appendXMLXCalibration.vi" Type="VI" URL="../subVIs/appendXMLXCalibration.vi"/>
			<Item Name="appendXMLYCalibration.vi" Type="VI" URL="../subVIs/appendXMLYCalibration.vi"/>
			<Item Name="appendXMLImageServer.vi" Type="VI" URL="../subVIs/appendXMLImageServer.vi"/>
			<Item Name="SaveConfig.vi" Type="VI" URL="../subVIs/SaveConfig.vi"/>
			<Item Name="appendXMLCameraName.vi" Type="VI" URL="../subVIs/appendXMLCameraName.vi"/>
			<Item Name="appendXMLOntrak.vi" Type="VI" URL="../subVIs/appendXMLOntrak.vi"/>
			<Item Name="TCP multiple open.vi" Type="VI" URL="../subVIs/TCP/TCP multiple open.vi"/>
			<Item Name="TCP multi close.vi" Type="VI" URL="../subVIs/TCP/TCP multi close.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="BeamPointing" Type="EXE">
				<Property Name="App_INI_aliasGUID" Type="Str">{5D83DCEE-824F-401E-B414-2902A59EF2D8}</Property>
				<Property Name="App_INI_GUID" Type="Str">{D7289F46-893D-4498-9E26-E57F106CEAF8}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="App_winsec.description" Type="Str">http://www.LBNL.com</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{F2E63EA1-0D0D-46DF-88B3-A9251C771E1F}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">BeamPointing</Property>
				<Property Name="Bld_excludeLibraryItems" Type="Bool">true</Property>
				<Property Name="Bld_excludePolymorphicVIs" Type="Bool">true</Property>
				<Property Name="Bld_localDestDir" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/BeamPointing</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{6890B81D-1CE1-4A42-9089-2B40C81A308B}</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">BeamPointing.exe</Property>
				<Property Name="Destination[0].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/BeamPointing/BeamPointing.exe</Property>
				<Property Name="Destination[0].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/BeamPointing/data</Property>
				<Property Name="Destination[1].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Exe_iconItemID" Type="Ref">/My Computer/target.ico</Property>
				<Property Name="Source[0].itemID" Type="Str">{7DAD4B4E-7DE5-4141-8425-B301F4335799}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/BeamPointing General v08.vi</Property>
				<Property Name="Source[1].type" Type="Str">VI</Property>
				<Property Name="Source[2].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[2].itemID" Type="Ref">/My Computer/BeamPointing General hacking.vi</Property>
				...
				<Property Name="TgtF_targetfileGUID" Type="Str">{BEAC8158-3055-4CF7-A84C-CABBE90DD267}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">BeamPointing.exe</Property>
			</Item>
			<Item Name="TRAserver" Type="EXE">
				<Property Name="App_INI_aliasGUID" Type="Str">{4255D8FC-ED66-48CD-9B93-8847E844F83D}</Property>
				<Property Name="App_INI_GUID" Type="Str">{956C0496-B19E-4A8B-9CCF-642A1EA48B97}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="App_winsec.description" Type="Str">http://www.LBNL.com</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{54EE63AF-EDF4-4714-AE36-9D3766BACC62}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">TRAserver</Property>
				<Property Name="Bld_excludeLibraryItems" Type="Bool">true</Property>
				<Property Name="Bld_excludePolymorphicVIs" Type="Bool">true</Property>
				<Property Name="Bld_localDestDir" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/TRAserver</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{A6615315-AA39-4C62-80C7-BE0E9599C16A}</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">TRAserver.exe</Property>
				<Property Name="Destination[0].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/TRAserver/TRAserver.exe</Property>
				<Property Name="Destination[0].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/TRAserver/data</Property>
				<Property Name="Destination[1].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Source[0].itemID" Type="Str">{7DAD4B4E-7DE5-4141-8425-B301F4335799}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/TRA server.vi</Property>
				...
				<Property Name="TgtF_companyName" Type="Str">LBNL</Property>
				<Property Name="TgtF_fileDescription" Type="Str">TRAserver</Property>
				<Property Name="TgtF_internalName" Type="Str">TRAserver</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2010 LBNL</Property>
				<Property Name="TgtF_productName" Type="Str">TRAserver</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{4D666A0A-B4EF-4390-AF49-43702E8DEEF4}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">TRAserver.exe</Property>
			</Item>
			<Item Name="ManualMoveGeneral" Type="EXE">
				<Property Name="App_INI_aliasGUID" Type="Str">{444F432D-3038-486C-92FD-734169FCCB95}</Property>
				<Property Name="App_INI_GUID" Type="Str">{6EC17500-D31D-4316-ADAF-E25C20E38F5C}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="App_winsec.description" Type="Str">http://www.LBNL.com</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{AC97B65D-9667-4DC0-ABAC-03FE7310233D}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">ManualMoveGeneral</Property>
				<Property Name="Bld_excludeLibraryItems" Type="Bool">true</Property>
				<Property Name="Bld_excludePolymorphicVIs" Type="Bool">true</Property>
				<Property Name="Bld_localDestDir" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/NI_AB_PROJECTNAME/ManualMoveGeneral</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{524B964A-31D5-4601-AC22-FEE825A84C19}</Property>
				<Property Name="Bld_version.major" Type="Int">1</Property>
				<Property Name="Destination[0].destName" Type="Str">ManualMoveGeneral.exe</Property>
				<Property Name="Destination[0].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/NI_AB_PROJECTNAME/ManualMoveGeneral/ManualMoveGeneral.exe</Property>
				<Property Name="Destination[0].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="Destination[0].preserveHierarchy" Type="Bool">true</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">/C/GEECS/Developers Version/builds/Interface builds/Non-General GUIs/BELLA/NI_AB_PROJECTNAME/ManualMoveGeneral/data</Property>
				<Property Name="Destination[1].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Source[0].itemID" Type="Str">{7DAD4B4E-7DE5-4141-8425-B301F4335799}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/manual-move-general.vi</Property>
				<Property Name="Source[1].sourceInclusion" Type="Str">TopLevel</Property>
				<Property Name="Source[1].type" Type="Str">VI</Property>
				<Property Name="Source[2].Container.applyInclusion" Type="Bool">true</Property>
				<Property Name="Source[2].destinationIndex" Type="Int">0</Property>
				...
				<Property Name="SourceCount" Type="Int">3</Property>
				<Property Name="TgtF_companyName" Type="Str">LBNL</Property>
				<Property Name="TgtF_fileDescription" Type="Str">ManualMoveGeneral</Property>
				<Property Name="TgtF_internalName" Type="Str">ManualMoveGeneral</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2010 LBNL</Property>
				<Property Name="TgtF_productName" Type="Str">ManualMoveGeneral</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{03915D98-2ABA-4F93-A50C-E2A4E364D0A0}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">ManualMoveGeneral.exe</Property>
			</Item>
		</Item>
	</Item>
</Project>
